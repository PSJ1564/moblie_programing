...
public class ItemModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_mode); // ✅ 수정된 레이아웃 사용
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(totalTime, 1000) {
            ...
            public void onFinish() {
                ...
                running = false;
                // 점수 저장
                ScoreDatabaseHelper dbHelper = new ScoreDatabaseHelper(ItemModeActivity.this);
        ...
        btnDestroy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(destroyCount > 0) {
                    ...
                    Toast.makeText(ItemModeActivity.this, "🧨블록 제거 아이템 사용: 제거할 블록을 선택하세요!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ItemModeActivity.this, "❌블록 제거 아이템 없음.", Toast.LENGTH_SHORT).show();
                    btnDestroy.setVisibility(View.INVISIBLE);
                }
            }
        });
        ...
        btnSwap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(swapCount > 0) {
                    ...
                    Toast.makeText(ItemModeActivity.this, "🔄블록 교환 아이템 사용: 첫 번째 블록을 선택하세요!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ItemModeActivity.this, "❌블록 교환 아이템 없음.", Toast.LENGTH_SHORT).show();
                    btnSwap.setVisibility(View.INVISIBLE);
                }
            }
        });
    ...
    private void destroySelectedBlock(int row, int col) {
        ...
        Toast.makeText(ItemModeActivity.this, "💥블록 제거!" + destroyCount + "개 남음", Toast.LENGTH_SHORT).show();
    }
    ...
    private void handleSwapBlock(int row, int col) {
        if(!isFirstSwapSelected) {
            ...
            swapCount--;
            Toast.makeText(ItemModeActivity.this, "🔄블록 교환 완료!" + swapCount + "개 남음", Toast.LENGTH_SHORT).show();
    ...
    private void uploadScoreWithLimit(String nickname, int newScore) {
        ...
        dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ItemModeActivity.this, "🔥 랭킹 업로드 실패", Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void saveScore(DatabaseReference dbRef, String nickname, int score) {
        ...
        dbRef.child(key).setValue(data)
                .addOnSuccessListener(aVoid ->
                        Toast.makeText(ItemModeActivity.this, "✅ 점수 저장 완료!", Toast.LENGTH_SHORT).show()
                )
                .addOnFailureListener(e ->
                        Toast.makeText(ItemModeActivity.this, "❌ 저장 실패: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                );
    }
